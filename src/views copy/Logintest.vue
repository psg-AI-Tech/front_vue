      ...
      <div class="login-box">
        ...
        >
          ...
          <el-form-item style="width: 100%">
            <div>
              <el-button
                  type="primary"
                  style="width: 100%; background-color: #409EFF; font-size: 20px; margin-top: 20px"
                  @click="userLogin"
                  round
              >登录
              </el-button
            ...
            <div class="mt5">
              <el-link type="info" @click="registerData.registerFlag = true" :underline="false"
                       style="width: 100%; font-size: 16px; text-align: center; margin-top: 10px">立即注册
              </el-link>
            </div>
          </el-form-item>
        </el-form>
        ...
        >
          ...
          <el-form-item style="width: 100%">
            ...
            <div class="mt5">
              <el-link type="warning" @click="registerData.registerFlag = false" :underline="false"
                       style="width: 100%; font-size: 16px; text-align: center; margin-top: 10px">返回登录
              </el-link>
            </div>
          </el-form-item>
        </el-form>
